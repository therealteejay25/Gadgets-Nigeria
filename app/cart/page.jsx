        ...
        <div className="flex-1">
          <div className="flex items-center justify-between mb-8 border-b border-gray-500/30 pb-6">
            <p className="text-2xl md:text-3xl text-gray-500">
              Your <span className="font-medium text-[#15334B]">Cart</span>
            </p>
                    ...
                    <tr key={itemId}>
                      <td className="flex items-center gap-4 py-4 md:px-4 px-1">
                        <div>
                          ...
                          <button
                            className="md:hidden text-xs text-[#15334B] mt-1"
                        ...
                        <div className="text-sm hidden md:block">
                          ...
                          <button
                            className="text-xs text-[#15334B] mt-1"
                            onClick={() => updateCartQuantity(product._id, 0)}
                          >
                            Remove
                          </button>
          ...
          <button onClick={()=> router.push('/all-products')} className="group flex items-center mt-6 gap-2 text-[#15334B]">
            <Image
